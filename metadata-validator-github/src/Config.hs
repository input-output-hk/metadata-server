...
import Cardano.Metadata.Validate.GitHub (ExpectedBaseBranch(ExpectedBaseBranch))
...
parseOpts = Opts
 <$> pAuthScheme
 <*> strOption (long "expect-branch" <> help "All PRs must be against this branch." <> showDefault <> value "main")
